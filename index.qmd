...
+ [Exercise 10.1 - Stan to sample from the posterior for the Weibull survival regression model](https://mattiasvillani.com/BayesianLearningBook/exercises/ch10solutions.html#sec-prob_weibullreg_lung_stan)
