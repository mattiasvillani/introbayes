...
Code: Getting started with Turing.jl: [instructions](code/Turing/turing_instructions.qmd) and [zip file with code](/code/turing.zip) | [Survival analysis in Stan](https://mc-stan.org/docs/stan-users-guide/truncation-censoring.html)
